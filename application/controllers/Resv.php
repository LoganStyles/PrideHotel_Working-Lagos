...
class Resv extends App
{
    ...
    public function showReservation($type, $resv_ID = 0, $master_id = 0, $page_number = 0, $action = "", $mode = "", $errors = FALSE)
    {
        ...
        $item_is_vat_exempted = $type . "_is_vat_exempted";
        ...
        if ($errors) {
            ...
            $data['received'][0]['is_vat_exempted'] = $this->input->post($item_is_vat_exempted);
            ...
            $data['received'][0]['is_vat_exempted'] = "0";
    ...
    public function confirmOperations()
    {
        ...
        switch ($type) {
            ...
            case 'vatExempt':
                $resv_id = $_POST['resv_id'];
                $res = $this->resv_model->exemptClientFromVatCharges($resv_id, $reason);
                break;
            case 'master':
                $resv_id = $_POST['resv_id'];
